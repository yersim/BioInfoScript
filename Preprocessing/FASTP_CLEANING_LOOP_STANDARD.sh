...
#fastp -i "${prefix}_R1_001.fastq.gz" -o CLEANED_READS/"${prefix}_FASTP_R1_001.fastq.gz" --report_title "${prefix}_fastp_report" --thread 38 -j REPORTS_CLEANED_READS/"${prefix}_fastp".json -h REPORTS_CLEANED_READS/"${prefix}_fastp".html
done

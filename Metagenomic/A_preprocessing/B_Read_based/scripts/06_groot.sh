...
filt_reads=/scratch/syersin2/Pastobiome_scratch/data/reformat
outdir=/scratch/syersin2/Pastobiome_scratch/data/groot_out
index_dir=/work/FAC/FBM/DMF/pvonaesc/vonasch_lab_general/syersin/GROOT/databases/groot-db.90.index
pydir=/users/syersin2/Pastobiome/Downstream_analysis/scripts
